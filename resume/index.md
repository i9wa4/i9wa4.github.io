...
**◆チームの中での役割：**<br>
シイエヌエス北海道にてプロジェクトのリーダーやサブリーダーを務めておりました。hacomonoでは一人データエンジニアとしてデータ基盤管理者・社内調整・目標管理などリーダー相当の業務を担当しておりました。現職GENDAではグループ企業のデータ利活用の窓口兼主担当として関係者との仕様調整やデータエンジニアリング全般を担当し、2025年4月からはチームメンバーの業務進捗管理・コードレビュー・1on1・採用活動などリーダー業務を受け持ちました。2026年4月よりデータエンジニアチームのマネージャーに就任しております。
...
**◆役割面：**<br>
直近：マネージャーとしてデータエンジニアチームの採用・育成・評価の仕組みを整え、チームとしての再現性ある成果創出体制を構築する<br>
3-5年後：データ組織の責任者として経営層と直接対話しながら、事業成長に必要なデータ戦略の立案と実行を主導する

**◆技術面：**<br>
データ基盤のアーキテクチャ設計から運用コスト最適化まで一気通貫で判断できる技術力を維持する<br>
データガバナンス (品質管理・カタログ・アクセス制御)
の仕組みを整備しデータ活用の信頼性を担保する<br>
AI・機械学習をデータ基盤に組み込み、分析の民主化と意思決定の高速化を実現する
...
| Data | BigQuery | 1.5年 | 管理者業務や IaC 化作業が可能 |
