...
GENDAでデータエンジニアチームのマネージャーを務めています。2026年10月からはデータサイエンスチームのマネージャーに就任予定です。

10年以上のソフトウェア開発経験を生かし、データエンジニアリングとMLOpsを通じて、データサイエンティストが分析・モデル開発に集中できる環境をつくってきました。データ基盤や開発環境の設計・実装から機械学習の本番運用まで自ら担い、事業部門との要件整理や採用・チーム運営にも取り組んでいます。

GENDAでは、グループ各社のデータ連携・データマートの整備や、機械学習基盤のDatabricks移行を進めてきました。データサイエンティストが使い慣れたエディタやAIエージェントを活用できるよう、OSS「jupyter-databricks-kernel」も開発しました。実務で得た知見を記事や登壇でも発信し、Databricks
MVP
2026に選出されました。業務委託ではPIVOTのデータ基盤改善も支援しています。
