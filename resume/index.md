...
ソフトウェアエンジニアリング、データエンジニアリング、MLOpsを横断し、データサイエンティストが分析や機械学習の価値検証に集中できる開発環境と運用体制をつくってきました。ソフトウェアエンジニアリング10年以上、データエンジニアリングと機械学習基盤運用4年以上の経験があります。現職GENDAではデータエンジニアチームのマネージャーとして、グループ横断のデータ利活用、関係者との調整、チーム運営をリードしています。2026年10月からはデータサイエンスチームのマネージャーに就任予定で、これまで技術面から行ってきた支援をチームづくりにも広げます。

事業部や営業とデータサイエンティストの間に立ち、要件整理からデータ基盤、実行環境、権限、CI/CD、運用までを一貫して整え、価値検証を本番運用につなげることを得意としています。なかでも技術面で特に力を入れてきたのが、データサイエンティストの開発体験改善です。DatabricksクラスターをローカルのJupyter環境やAIコーディングエージェントから利用できるOSS
jupyter-databricks-kernelを開発し、NotebookのテストやCI/CDを可能にしました。こうした取り組みとDatabricksコミュニティへの貢献が評価され、2026年8月にDatabricks
MVP 2026を受賞しました。
...
- 2026/06/30:
  [コンテキスト設計から考えるハーネスエンジニアリング](https://i9wa4.github.io/slides/2026-06-30-context-design-harness#/title-slide)
- 2026/03/06:
