...
[uv + Quarto でブログやスライドを作成して GitHub Pages で公開する (HTML エクスポートにも対応)](2025-12-15-uv-quarto-intro.qmd)
:::
...
[Markdown ライクな Quarto でブログやスライドを作って GitHub Pages で公開する](2024-08-25-publishing-github-pages-with-quarto.qmd)
...
![01 Quarto image](/assets/2025-05-06-quarto-slides/01-quarto.png)

複数のモードが選択できます。PDF Export Mode を選択すると PDF 印刷できる状態になります。

![02 Quarto image](/assets/2025-05-06-quarto-slides/02-quarto.png)
