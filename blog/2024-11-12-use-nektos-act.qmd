...
[WSL2でDocker buildをすると止まる問題("docker-credential-desktop.exe": executable file not found in $PATH, out: ``) #Docker - Qiita](https://qiita.com/rasuk/items/a36b29b8c79d02fc551a)
