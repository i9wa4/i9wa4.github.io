...
```{.bash filename=".devcontainer/start-jupyter.sh"}
#!/usr/bin/env bash
set -o errexit
...
[Databricks Connect 実践編 - ローカルから Databricks コンピュートを利用](2025-07-28-article3-databricks-connect.qmd)
