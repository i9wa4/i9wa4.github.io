...
`/claude-config-optimizer`・`/codex-config-optimizer` コマンドとして呼び出せるようになります。
...
以下のブロックを `~/.claude/skills/claude-config-optimizer/SKILL.md` にコピーして保存します。

```{.sh filename="terminal"}
mkdir -p ~/.claude/skills/claude-config-optimizer/references
```

````{.markdown filename="~/.claude/skills/claude-config-optimizer/SKILL.md"}
---
...
以下のブロックを `~/.claude/skills/codex-config-optimizer/SKILL.md` にコピーして保存します。

```{.sh filename="terminal"}
mkdir -p ~/.claude/skills/codex-config-optimizer/references
```

````{.markdown filename="~/.claude/skills/codex-config-optimizer/SKILL.md"}
---
