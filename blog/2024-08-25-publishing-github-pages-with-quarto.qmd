...
Markdown でブログやスライドを管理したい方に最適な Quarto による GitHub Pages 公開手順を紹介していきます。

スライド管理に興味がない方は適宜スライドに関する記述を無視しながら読み進めてください。

ここでは以下のドキュメントの手順をなぞりつつ、ブログ記事とスライドを管理するためのページ構成を導入します。

[Quarto – GitHub Pages](https://quarto.org/docs/publishing/github-pages.html)

## 1. 想定する対象者

- Linux (WSL2) もしくは Mac 利用者
- Git/GitHub の基本操作の説明がなくても読める方
- 取り急ぎドキュメント内のコード実行は不要な方
...
特にこだわりがなければ `username.github.io` がオススメです。
