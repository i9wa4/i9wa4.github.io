...
This is also why I still care about dotfiles. I want the behavior of my environment to live in text files that Git can track. I wrote more about that in [Why I Still Grow My Dotfiles in the Age of AI Coding Agents](/en/blog/2026-01-08-why-i-still-grow-my-dotfiles.html).
...
This is not required for `vde-layout`, but it helps when several agent workspaces are open at once. A session name tells me which project I am looking at before I even inspect the panes.

In my setup, this is tied to repository navigation. The exact tool does not matter. `ghq`, `zoxide`, shell hooks, or a small wrapper can all do the same job.
...
The next article is about the small mailbox layer I built on top of this setup: [`tmux-a2a-postman`](/en/blog/2026-05-17-tmux-a2a-postman-markdown-mail-for-ai-agent-teams.html).
