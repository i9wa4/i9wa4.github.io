...
The tradeoff is token use. Repeating local instructions in each mail costs context. I accept that overhead when the alternative is an ambiguous handoff that has to be reconstructed from a long conversation, screen state, or memory.
