...
The daemon TUI does not render a transcript like the one below. Read it as a fictional relay of an expected postman conversation using the roles from this example:
...
orchestrator> reviewer: review the result when worker is done.

worker> DONE: edited the section and rendered the page.

reviewer> APPROVED: evidence matches the requested scope.
