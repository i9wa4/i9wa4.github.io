...
description: |
  Every AI coding agent session leaves behind a trail of files. Investigation notes, plans, review results. I wrote mkmd --- a 50-line bash wrapper around mktemp. One command, auto-organized by project, date, and branch. Repo stays clean. Agent picks it up autonomously. Full script included.
