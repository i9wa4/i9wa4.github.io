...
Across software engineering, data engineering, and MLOps, I have built
development environments and operational practices that help data
scientists focus on analysis and validating machine-learning use cases.
I bring 10+ years of software engineering experience, including 4+ years
in data engineering and machine-learning platform operations. At GENDA,
I currently manage the Data Engineering Team, leading cross-group data
initiatives, stakeholder alignment, and team operations. In October
2026, I will take on the role of Data Science Team Manager, extending my
technical support for data scientists into team building.

I work between business units, sales teams, and data scientists,
covering requirements, data platforms, compute environments, access
controls, CI/CD, and operations to take experiments through to
production. I have placed particular emphasis on improving developer
experience for data scientists. I developed the open-source
jupyter-databricks-kernel, which lets local Jupyter environments and AI
coding agents use Databricks clusters and enables notebook testing and
CI/CD. This work and my contributions to the Databricks community earned
the Databricks MVP 2026 award in August 2026.
...
- June 30, 2026: [Harness Engineering Through the Lens of Context
  Design](https://i9wa4.github.io/slides/2026-06-30-context-design-harness#/title-slide)
...
- August 12, 2026: [Databricks MVP
  2026](https://credentials.databricks.com/a6c07ff2-6101-474c-8d4a-941d78794199)
