---
title: "Cursorの設定Tips集とCursorにデータ分析を任せる方法"
author:
  - name: 馬渡 大樹
...
draft: true
description: |
  [登壇資料] "Cursorの設定Tips集とCursorにデータ分析を任せる方法" in "2025-05-22 ミダスキャピタル 生成AI勉強会"
categories:
  - "slides"
  - "genda"
format:
...
### 3.1. [まとめ] Cursor で Databricks から効率良くデータ抽出する体制

1. [MCP] Databricks MCP Server を利用する
1. [Cursor 設定] auto-run mode を利用する
1. [その他設定] gitignore を設定して個人作業用フォルダを用意する
1. [dbt] dbt プロジェクト内の個人作業用フォルダを作業の場とする
    - テーブルの情報やデータ集計方法を学習させることができる

### 3.2. [まとめ] Cursor x データ抽出はいいぞ
