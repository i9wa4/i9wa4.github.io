...
format:
  revealjs:
    auto-stretch: false
    code-copy: true
    footer: "[2026-03-06 堅牢.py #2](https://kenro.connpass.com/event/383266/)"
    include-in-header:
...
:::: {.columns}
::: {.column width="50%"}
<iframe class="speakerdeck-iframe" src="https://speakerdeck.com/player/a80b5264ece14d11851cfe98a185ab30" title="Lets start your ML project by writing tests" allowfullscreen style="border: 0px; border-radius: 6px; width: 100%; height: auto; aspect-ratio: 560 / 315;"></iframe>
:::
::: {.column width="50%"}
::: {style="transform: scale(1.5); transform-origin: top left;"}
<blockquote class="twitter-tweet"><p lang="ja" dir="ltr">Jupyter Notebook 運用ですすみません<br> <a href="https://twitter.com/hashtag/kenro_py?src=hash&amp;ref_src=twsrc%5Etfw">#kenro_py</a></p>&mdash; uma-chan🌲 (@i9wa4_) <a href="https://twitter.com/i9wa4_/status/1991452556334362679?ref_src=twsrc%5Etfw">November 20, 2025</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
:::
:::
::::
