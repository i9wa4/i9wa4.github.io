...
要素:
  ...
  - ポイント: 15分遅延で予算超過を検知。ライトユーザーが15分で予算を使い切ることはほぼない
-->
...
要素:
  - Dev Container: 環境変数（DATABRICKS_HOST、GOOSE_PROVIDER）とdatabricks auth login
