...
![](/assets/2025-11-07-tamesare-data-sapporo/aws-ml-architecture.drawio.png){width="100%"}
...
![](/assets/2025-11-07-tamesare-data-sapporo/job-migration.drawio.png)

## 5. まとめ

### 5.1. AWS 知見がそのまま活きる

- S3 や IAM Role など、既存の AWS 知識が活用できる
- AWS 構成からの移行がスムーズ
...
::: {style="flex: 1;"}
[![](/assets/2025-11-07-tamesare-data-sapporo/zenn-twitter-card.jpeg){width="100%"}](https://zenn.dev/genda_jp/articles/724a597e8f18ff)
:::
